...
#  Default: set()
# c.JupyterHub.admin_users = set(["etd"])
...
#  Default: '/home/codespace/.local/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/codespace/.local/share/jupyterhub'
...
allow_origin = "*"
c.Spawner.args = [f'--NotebookApp.allow_origin={allow_origin}']
...
#  Default: set()
c.Authenticator.allowed_users = set(["etd"])
c.Authenticator.admin_users = set(["etd"])
